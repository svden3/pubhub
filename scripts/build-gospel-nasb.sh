...
# Gospel of John PDF Builder - NASB Version
# Uses NASB (New American Standard Bible) for English Scripture

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(dirname "$SCRIPT_DIR")"
INPUT_DIR="$PROJECT_ROOT/books/bible/gospel-of-john-nasb"
OUTPUT_DIR="$PROJECT_ROOT/output"
COMBINED_MD="$OUTPUT_DIR/gospel-of-john-nasb-combined.md"
OUTPUT_PDF="$OUTPUT_DIR/gospel-of-john-nasb.pdf"
TEMPLATE="$PROJECT_ROOT/templates/pdf/gospel-of-john-original.latex"

echo "=========================================="
echo "📖 Gospel of John PDF Generator (NASB)"
echo "=========================================="
echo "English Scripture: New American Standard Bible"
echo ""
