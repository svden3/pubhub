#!/bin/bash
# ============================================================================
# Build Gospel of John - Devotional Edition (2026 Enhanced)
# 6×9" Trade Paperback with TikZ Maps, Red Letter Bible, Vine Decorations
# Uses the gospel-devotional-2026.latex template
# ============================================================================
...
TEMPLATE="$PROJECT_ROOT/templates/pdf/gospel-devotional-2026.latex"
...
if [ "$VERSION" = "-h" ] || [ "$VERSION" = "--help" ]; then
    ...
    echo ""
    echo "  Builds Gospel of John Devotional PDF with the specified English version."
    echo ""
    echo "  Versions:"
    ...
    echo ""
    echo "  Template: gospel-devotional-2026.latex"
    echo "  Features: 6×9\" Trade Paperback, TikZ Maps, Red Letter Bible"
    exit 0
fi
...
OUTPUT_FILE="$OUTPUT_DIR/gospel-of-john-devotional-${VERSION}.pdf"

VERSION_UPPER=$(echo "$VERSION" | tr '[:lower:]' '[:upper:]')

echo "============================================"
echo "Building Gospel of John - Devotional Edition (2026)"
echo "Version: $VERSION_UPPER"
echo "Format: 6×9\" Trade Paperback"
echo "Features: TikZ Maps, Red Letter Bible, Vine Decorations"
...
COMBINED_FILE="$OUTPUT_DIR/gospel-of-john-devotional-combined.md"
...
---
title: 約翰福音研讀
subtitle: Gospel of John Deep Study - $VERSION_UPPER Devotional Edition
author: 三書精讀出版系統
date: 2026年1月
...
if [ -f "$OUTPUT_FILE" ]; then
    ...
    echo ""
    echo "============================================"
    echo "SUCCESS: Gospel of John Devotional ($VERSION_UPPER)"
    echo "   Format: 6x9\" Trade Paperback"
